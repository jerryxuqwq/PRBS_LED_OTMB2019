...
REM  /   /         Filename : implement_bat.ejava
REM /___/   /\     
REM \   \  /  \
REM  \___\/\___\
REM
...
COPY Gem_firefly_top.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\Gem_firefly_top.ucf -p xc6vlx240t-ff1156-1 Gem_firefly_top.ngc Gem_firefly_top.ngd
...
ECHO 'Running NGD'
map -p xc6vlx240t-ff1156-1 -o mapped.ncd Gem_firefly_top.ngd
...
netgen -ofmt verilog -sim -sdf_path ../../implement/results -dir . -tm Gem_firefly_top -w routed.ncd routed.v
