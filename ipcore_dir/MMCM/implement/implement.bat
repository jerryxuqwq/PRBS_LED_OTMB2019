...
xst -ifn xst.scr
move MMCM_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\MMCM_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc MMCM_exdes.ucf MMCM_exdes

echo 'Running map'
map -timing -pr b MMCM_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm MMCM_exdes -w routed.ncd routed.v
cd ..
