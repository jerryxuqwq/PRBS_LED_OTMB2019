...
gui_sg_addsignal -group MMCM_group {{Status_control}} -divider
gui_sg_addsignal -group MMCM_group {MMCM_tb.RESET}
gui_sg_addsignal -group MMCM_group {MMCM_tb.LOCKED}
