...
COPY dummy_top.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\dummy_top.ucf -p xc6vlx240t-ff1156-1 dummy_top.ngc dummy_top.ngd
...
ECHO 'Running NGD'
map -p xc6vlx240t-ff1156-1 -o mapped.ncd dummy_top.ngd
...
netgen -ofmt verilog -sim -sdf_path ../../implement/results -dir . -tm dummy_top -w routed.ncd routed.v
