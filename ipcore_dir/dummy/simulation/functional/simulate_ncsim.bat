...
mkdir work
REM MGT Wrapper
ncvlog -work work   ..\..\..\dummy_gtx.v
ncvlog -work work   ..\..\..\dummy.v

ncvlog -work work  %SIMPLEX_PARTNER%\rx_dummy_gtx.v
ncvlog -work work  %SIMPLEX_PARTNER%\rx_dummy.v


REM Example Design modules
ncvlog -work work  ..\..\example_design\frame_gen.v
ncvlog -work work  %SIMPLEX_PARTNER%\rx_dummy\example_design\frame_check.v
ncvlog -work work  ..\..\example_design\dummy_top.v
ncvlog -work work  %SIMPLEX_PARTNER%\rx_dummy\example_design\rx_dummy_top.v
